                ...
                <div class=" md:grid md:grid-cols-4 gap-8">
                    <div class="m-4 flex items-start justify-center col-span-1">
                        <div class="flex flex-col justify-center items-center">
                            <img src="/storage/categories/default.svg" id="categoryImage" class="w-36 h-36 object-contain rounded-full" alt="">
                            <input type="file"
                                   name="image"
                                   id="imgupload"
                                   onchange="$('#categoryImage').attr('src', window.URL.createObjectURL(this.files[0]))"
                                   hidden/>
